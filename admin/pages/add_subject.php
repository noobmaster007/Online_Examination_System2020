...
if ($result->num_rows > 0) {
    ...
    header("location:../subject.php?DUPLICATE RECORD FOUND!!");
    }
} else {
...
if ($conn->query($sql) === TRUE) {
    header("location:../subject.php?Subject is Added Successfully!!");
} else {
    header("location:../subject.php?Could Not Add Subject!!");
}
