                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        ...
                                        <tbody>';
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <button type="button" class="btn btn-default" aria-expanded="false"><a'; ?> <?php print ' href="pages/drop_ct.php?id='.$row['category_id'].'">Drop Category</a></button>
                                            </div></td>
										...
										<div class="form-group">
											...
											<?php
											include '../database/config.php';
											$sql = "SELECT name FROM tbl_departments";
                                            $result = $conn->query($sql);
